...
- Unsupported-supplier discovery uses `activeTab` plus an exact optional HTTPS
  ...
  GET-navigation-only, serial, and capped at 40 pages/depth four/60 seconds interactively
