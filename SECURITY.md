...
- Unsupported-supplier discovery uses `activeTab` plus an exact optional HTTPS
  ...
  GET-navigation-only, capped at four inactive route probes and 40 pages/depth four/60 seconds interactively
